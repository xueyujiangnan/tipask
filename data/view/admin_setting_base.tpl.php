...
<? } } ?>
    ...
    <table cellspacing="1" cellpadding="4" width="100%" align="center" class="tableborder">
        ...
        <tr>
            <td class="altbg1" width="45%"><b>站内提问回答需要达到的魅力值:</b><br>
                <span class="smalltxt">填写魅力值（整数，包括负数）之后，当用户的魅力值小于该值时，将不能提问和回答，合理的设置可以让站内用户相互监督</span></td>
            <td class="altbg2"><input type="text" name="allow_credit3" value="<?=$setting['allow_credit3']?>" /></td>
        </tr>
        <tr>
